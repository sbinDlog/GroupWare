                        	...
                        	<c:otherwise>
                        		...
                        		<div class="d-flex hover-actions-trigger py-2 border-bottom">
		                           <div class="row justify-content-between align-items-md-center btn-reveal-trigger border-200 gx-0 flex-1">
		                              ...
		                              <div class="col-3 col-md-3 col-xl-3 col-xxl-3">
		                                 <div class="mb-1 mb-md-0 d-flex align-items-center lh-1">
		                                    <label class="form-check-label mb-1 mb-md-0 mb-xl-1 mb-xxl-0 fs-0 me-2 line-clamp-1 text-900" style="line-height: 1.5;"><fmt:formatDate value="${unreadMail.mailDate }" pattern="MM월dd일 HH:mm:ss"/></label>
		                                 </div>
		                              </div>
		                           </div>
		                        </div>
                ...
                <div class="grid-stack-item-content">
                  ...
                  <div class="card h-100">
                     <div class="card-header border-bottom-0 pb-0">
                        <div class="row justify-content-between align-items-center mb-4">
                           <div class="col-auto">
                              <h3 class="text-1100">최근 추가 주소록 <a href="/add/admin.do"><span class="fas fa-plus me-1" style="font-size: 16px; color: black"></span></a></h3>
                           </div>
                        </div>
                     </div>
                     <div class="card-body py-0 scrollbar text-center">
                        ...
                        <c:forEach items="${portlet.dataList }" var="empVO">
                        <div class="d-flex hover-actions-trigger py-2 border-bottom">
                           <div class="row justify-content-between align-items-md-center btn-reveal-trigger border-200 gx-0 flex-1">
                              <div class="col-2 col-md-2 col-xl-2 col-xxl-2">
                                 <div class="mb-1 mb-md-0 d-flex align-items-center lh-1">
                                    <label class="form-check-label mb-1 mb-md-0 mb-xl-1 mb-xxl-0 fs-0 me-2 line-clamp-1 text-900" style="line-height: 1.5;">${empVO.empName }</label>
                                 </div>
                              </div>
                              <div class="col-2 col-md-2 col-xl-2 col-xxl-2">
                                 <div class="mb-1 mb-md-0 d-flex align-items-center lh-1">
                                    <label class="form-check-label mb-1 mb-md-0 mb-xl-1 mb-xxl-0 fs-0 me-2 line-clamp-1 text-900" style="line-height: 1.5;">${empVO.codeVO.cdName }</label>
                                 </div>
                              </div>
                              <div class="col-4 col-md-4 col-xl-4 col-xxl-4">
                                 <div class="mb-1 mb-md-0 d-flex align-items-center lh-1">
                                    <label class="form-check-label mb-1 mb-md-0 mb-xl-1 mb-xxl-0 fs-0 me-2 line-clamp-1 text-900" style="line-height: 1.5;">${empVO.deptVO.deptName }</label>
                                 </div>
                              </div>
                              <div class="col-4 col-md-4 col-xl-4 col-xxl-4">
                                 <div class="mb-1 mb-md-0 d-flex align-items-center lh-1">
                                    <label class="form-check-label mb-1 mb-md-0 mb-xl-1 mb-xxl-0 fs-0 me-2 line-clamp-1 text-900" style="line-height: 1.5;">${empVO.empHp }</label>
                                 </div>
                              </div>
                           </div>
                        </div>
                  ...
                  <div class="card">
                     <div class="card-body d-flex flex-column scroll">
                        <div class="row align-items-end justify-content-between pb-4 g-3">
                           <div class="col-auto">
                              <h3>
                                 	진행중업무 <a href="/adminTask.do"><span class="fas fa-plus me-1" style="font-size: 16px; color: black"></span></a>
                              </h3>
                           </div>
                        </div>
                ...
                <div class="grid-stack-item-content">
                  ...
                  <div class="card h-100">
                     <div class="card-header border-bottom-0 pb-0">
                        <div class="row justify-content-between align-items-center mb-4">
                           <div class="col-auto">
                              <h3 class="text-1100">완료기안서 <a href="/admin/draft.do"><span class="fas fa-plus me-1" style="font-size: 16px; color: black"></span></a></h3>
                           </div>
                        </div>
                        <div class="d-flex hover-actions-trigger py-2 border-bottom bg-light">
                        	 <div class="col-4 col-md-4 col-xl-4 col-xxl-4">
                   ...
                   <c:otherwise>
                   	 <c:forEach items="${portlet.dataList }" var="allDraftList">
                        <div class="d-flex hover-actions-trigger py-2 border-bottom">
                           <div class="row justify-content-between align-items-md-center btn-reveal-trigger border-200 gx-0 flex-1">
	                              <div class="col-4 col-md-4 col-xl-4 col-xxl-4">
	                                 <div class="mb-1 mb-md-0 d-flex align-items-center lh-1">
	                                    <a href="/admin/draftdetail.do?drftCd=${allDraftList.drftCd }">
	                                    	<label class="form-check-label mb-1 mb-md-0 mb-xl-1 mb-xxl-0 fs-0 me-2 line-clamp-1 text-900" style="line-height: 1.5;">
	                                    	${allDraftList.drftTitle }
	                                    </label></a>
	                                 </div>
	                              </div>
	                              <div class="col-3 col-md-3 col-xl-3 col-xxl-3">
	                                 <div class="mb-1 mb-md-0 d-flex align-items-center lh-1">
	                                   	<label class="form-check-label mb-1 mb-md-0 mb-xl-1 mb-xxl-0 fs-0 me-2 line-clamp-1 text-900" style="line-height: 1.5;">
	                                   	${allDraftList.empName }</label>
	                                 </div>
	                              </div>
	                              <div class="col-3 col-md-3 col-xl-3 col-xxl-3">
	                                 <div class="mb-1 mb-md-0 d-flex align-items-center lh-1">
	                                    <label class="form-check-label mb-1 mb-md-0 mb-xl-1 mb-xxl-0 fs-0 me-2 line-clamp-1 text-900" style="line-height: 1.5;">
	                                    	<c:set value="${allDraftList.drftDate }" var="draftDate"/>
	                              ...
	                              <div class="col-2 col-md-2 col-xl-2 col-xxl-2">
	                                 <div class="mb-1 ml-8 mb-md-0 d-flex lh-1" >
	                                    <label class="form-check-label mb-1 mb-md-0 mb-xl-1 mb-xxl-0 fs-0 me-2 line-clamp-1 text-900" style="line-height: 1.5;">
	                                       <c:if test="${allDraftList.drftAprvse eq '전결'}">
	                                      	 <span class="badge badge-phoenix badge-phoenix-warning" >${allDraftList.drftAprvse }</span>
	                                       </c:if>
	                                       <c:if test="${allDraftList.drftAprvse eq '결재'}">
	                                      	 <span class="badge badge-phoenix badge-phoenix-success" >${allDraftList.drftAprvse }</span>
	                                       </c:if>
	                                    </label>
	                                 </div>
	                              </div>
                              	...
                              	<c:otherwise>
				                   <c:forEach items="${portlet.data.noticeList}" var="notice" varStatus="i">
		                               ...
		                               <tr class="position-static">
		                                 ...
		                                 <td class="align-middle white-space-nowrap start ps-10 text-start">
		                                  <p class="mb-0 fs--1 text-900"><a href="/noticedetail.do?noNo=${notice.noNo}">${notice.noTitle}</a></p>
		                                 </td>
                              	...
                              	<c:otherwise>
				                   <c:forEach items="${portlet.data.feventList}" var="fevent" varStatus="i">
		                               ...
		                               <tr class="position-static">
		                                 ...
		                                 <td class="align-middle white-space-nowrap start ps-10 text-start">
		                                  <p class="mb-0 fs--1 text-900"><a href="/feventdetail.do?feNo=${fevent.feNo}">${fevent.feTitle}</a></p>
		                                 </td>
		                                 <td class="align-middle white-space-nowrap deadline ps-3 text-center">
			...
			<div class="card px-3 bg-light" style="height:400px;">
				<div class="row">
					<div class="col-12 pt-2">
						<span class="fw-bold fs-1">금일 근무유형/출근현황</span>
					</div>
