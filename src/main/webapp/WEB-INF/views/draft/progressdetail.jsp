...
<sec:authentication property='principal.emp.empSign' var="empSign"/>

<body>
<h2 class="uil-file-check"><a href="/draft/progdoc.do">기안함 </a> > 진행중문서</h2>
<br/>
	<div>
		<table class="table table-sm" style="vertical-align: middle; height: 70px;">
		    ...
		    <tr>
		      ...
		      <th>* 기안일</th>
		      	<c:set var="drftDate" value="${progDetail.drftDate }"/>
...
<!-- 			<textarea id="ckeditor" name="" class="form-control" rows="14" readonly="readonly"> -->
			...
			<!-- 결재란 시작 -->
				<div>
					<table border="1" style="width: 450px; margin-right:180px; float: right; text-align: center; border-collapse: collapse; table-layout: fixed;">
						<tbody>
							<tr>
	...
	<div>
		<table class="table table-sm">
		    <tr>
		      ...
		      <c:choose>
		      	<c:when test="${empty progDetail.drftReason }">
			      <td>미작성되었습니다.</td>
		      	</c:when>
				<c:otherwise>
					<td>${progDetail.drftReason }</td>
				</c:otherwise>
		      </c:choose>
		      <td colspan="2"></td>
		    </tr>
