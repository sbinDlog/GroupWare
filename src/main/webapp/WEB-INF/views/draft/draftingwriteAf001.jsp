...
<div id="atrzfContent" style="display:none;">${af001Form.atrzfContent}</div>
...
<!-- 		<button class="btn btn-outline-info" type="button" data-bs-toggle="modal" data-bs-target="#scrollingLong2">양식 불러오기</button> -->
	</div>
	<div class="card-body">
		<div class="col-md-12">
...
<br>
	...
	<input type="hidden" name="atrzfCd" value="af001" id="formCd">
</form>
...
$(function(){
	...
	CKEDITOR.instances.ckeditor.setData($("#atrzfContent").html());

	$('document').ready(function() {
		var authFormCd = "af001";
		var okBtn = $("#okBtn");
		var tempBtn = $("#tempBtn");
