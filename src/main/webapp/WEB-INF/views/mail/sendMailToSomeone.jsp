							...
							<div class="col-12">
								...
								<div class="input-group mb-1">
									<div class="form-control" type="text" id="rcvPlace">
										<span class="btn btn-sm btn-phoenix-secondary rounded-pill me-1 mb-1">${empVO.fullName}<c:if test="${empVO.empNo ne 'admin' }">/${empVO.deptVO.deptName}</c:if></span>
										<input type="hidden" name="mailrEmpnoList" value="${empVO.empNo}" id="mailrEmpnoList">
									</div>
								</div>
							</div>
							<div class="col-12">
...
$(document).on('click', '#mailBtn', function(){
	  ...
	  var mailrEmpnoList = $('#mailrEmpnoList').val();
