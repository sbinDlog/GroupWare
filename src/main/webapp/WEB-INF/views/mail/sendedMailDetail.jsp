				...
				<div class="card-body">
					<form class="d-flex flex-column h-100" id="sendMailForm">
						<div class="row g-3 mb-2">
							<div class="col-9">
								<div class="row">
									...
									<div class="col-12 pb-3">
										...
										<!-- 보낸직원 들어가는 곳 -->
										<div class="form-control bg-light" type="text" id="refPlace">											<c:forEach items="${mailList.mailRec }" var="rec">
							...
							<div class="col-3" style="padding: 4px 0px 0px 20px;">
								<div class="d-flex align-items-center mb-2">
									<span class="me-2" data-feather="calendar"></span>
									<h5 class="text-1000 mb-0">발신날짜</h5>
								</div>
