...
<!-- 									    <button class="btn btn-outline-info me-1 mb-1" type="button" id="listBtn">목록</button> -->
								    <!-- 작성자일떄 끝 -->
										  	<button class="btn btn-phoenix-secondary" id="modifyBtn" data-sort="notice">
...
<!-- 										    <button class="btn btn-outline-info" type="button" id="listBtn">목록</button> -->
							  		</c:when>
								  <c:otherwise>
<!-- 									  	<button class="btn btn-outline-info me-1 mb-1" type="button" id="listBtn">목록</button> -->
								  </c:otherwise>
...
$(function(){
	...
	deleteBtn.on('click', function(){
		customConfirm('정말로 삭제하시겠습니까?').then((userConfirmed) => {
