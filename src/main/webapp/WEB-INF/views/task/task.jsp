		        ...
		        <tbody style="vertical-align: middle;">
		            <c:choose>
		                <c:when test="${empty taskList}">
		                    <tr>
		                        <td colspan="6" style="text-align:center;">조회하신 프로젝트가 존재하지 않습니다.</td>
		                    </tr>
		                </c:when>
		                <c:otherwise>
		                        ...
		                        <tr>
		                            ...
		                            <td style="font-size:14px;">
		                            	<div class="avatar avatar-xl ">
		                            		<c:choose>
		                            			<c:when test="${loginId eq task.empNo}">
								                    <img class="rounded-circle border border-danger" src="${pageContext.request.contextPath }${task.empPhoto}" alt="" />
								                </c:when>
								                <c:otherwise>
