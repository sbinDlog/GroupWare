...
<form id="taskform" method="post" name="testForm" action="/taskinsert.do" onsubmit='return formSubmit()'>
	<div class="container">
		<h2><a href="/task.do">내업무현황</a> > 업무등록</h2>
...
<!-- 								<h3 class="card-title mb-4">업무 등록</h3> -->
								...
								<div class="row gx-3">
									<div class="col-12 col-sm-6 col-xl-12">
										<div class="mb-4">
											<div class="d-flex flex-wrap mb-2">
												<h5 class="mb-0 text-1000 me-2">프로젝트명</h5><span class="text-danger">*</span>
											</div>
											 <input class="form-control mb-xl-3" type="text"  placeholder="프로젝트명" id="taskTitle" name="taskTitle" value="${taskVO.taskTitle}" >${taskVO.taskTitle }</input>
									...
									<div class="col-12 col-sm-6 col-xl-12">
										<div class="mb-4">
											<div class="d-flex flex-wrap mb-2">
												<h5 class="mb-2 text-1000 me-2">프로젝트 시작 ~ 종료 일자</h5><span class="text-danger">*</span>
											</div>
											<div class="float">
												<div class="d-flex align-items-center">
													<div class="form-group row align-middle">
														<div class="col">
															<input class="form-control" id="basic-form-dob" type="date" name="taskStartdate" value="${taskVO.taskStartdate }"/>
														</div>
														<div class="col text-center align-self-center">~</div>
														<div class="col">
															<input class="form-control" id="basic-form-dob" type="date" name="taskEnddate" value="${taskVO.taskEnddate }" />
														</div>
													</div>
												</div>
											</div>
									...
									<div class="col-12 col-sm-6 col-xl-12">
										<div class="mb-4">
										<div class="d-flex flex-wrap mb-2">
											<h5 class="mb-2 text-1000 me-2">프로젝트 내용</h5><span class="text-danger">*</span>
										</div>
...
<script type="text/javascript">
	...
	function setMinimumTaskEndDate() {
	  ...
	  function deleteImage(buttonElement) {
		    var parentDiv = buttonElement.closest('.float');
		    if (parentDiv) {
		        parentDiv.remove(); // 이미지와 "x" 버튼이 포함된 부모 요소 삭제
		    }
		}
...
//  	console.log("선택된 사람[0] 부서 : " + teamEmp_select[0].original.deptVO);
	...
	if(cnt != 0){
		alert("업무책임자를 팀원으로 등록할 수 없어<br>제외하고 추가합니다.");
	}
