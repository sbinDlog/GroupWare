	...
	<div id="divCustomWrapper"
		...
		<div class="partition" id="draftSection"
			...
			<div class="inaRowRight"
				...
				<!-- 결재선 1 Start-->
				<span unselectable="on" contenteditable="false" class="comp_wrap" data-wrapper="" style="font-family: &amp; quot; malgun gothic&amp;quot; , dotum , arial, tahoma; font-size: 9pt; line-height: normal; margin-top: 0px; margin-bottom: 0px;">
					<!-- 결재선 타입, 결재자 수 -->
		...
		<table class="detailSection">
			...
			<tbody>
			<tr>
				<td class="subjectColumn dext_table_border_t dext_table_border_r dext_table_border_b dext_table_border_l" colspan="8">인적사항</td>
			</tr>
				<tr>
					<td class="subjectColumn dext_table_border_t dext_table_border_r dext_table_border_b dext_table_border_l" colspan="4">성명</td>
					
					<td colspan="4" class="detailColumn dext_table_border_t dext_table_border_r dext_table_border_b dext_table_border_l">
						<p style="text-align: center;"><span unselectable="on" contenteditable="false" class="comp_wrap" data-cid="4" data-dsl="{{text}}" data-wrapper="" style="width: 100%; font-family: &quot;malgun gothic&quot;, dotum, arial, tahoma; font-size: 9pt; line-height: normal; margin-top: 0px; margin-bottom: 0px;" data-value="" data-autotype="">${empVO.empName }</span></p>
					</td>
					
				</tr>
				<tr>
				<td class="subjectColumn dext_table_border_t dext_table_border_r dext_table_border_b dext_table_border_l" colspan="4">주민등록번호</td>
					<td colspan="4" class="detailColumn dext_table_border_t dext_table_border_r dext_table_border_b dext_table_border_l">
						<c:choose>
							<c:when test="${regNo eq 'secret' }">
								<p style="text-align: center;"><span unselectable="on" contenteditable="false" class="comp_wrap" data-cid="6" data-dsl="{{text}}" data-wrapper="" style="width: 100%; font-family: &quot;malgun gothic&quot;, dotum, arial, tahoma; font-size: 9pt; line-height: 18px; margin-top: 0px; margin-bottom: 0px;" data-value="" data-autotype="">${fn:substring(empVO.empRegno,0,8) }******</span></p>
							</c:when>
							<c:otherwise>
								<p style="text-align: center;"><span unselectable="on" contenteditable="false" class="comp_wrap" data-cid="6" data-dsl="{{text}}" data-wrapper="" style="width: 100%; font-family: &quot;malgun gothic&quot;, dotum, arial, tahoma; font-size: 9pt; line-height: 18px; margin-top: 0px; margin-bottom: 0px;" data-value="" data-autotype="">${empVO.empRegno }</span></p>
							</c:otherwise>
						</c:choose>
					</td>
				</tr>
				<tr>
					<td class="subjectColumn dext_table_border_t dext_table_border_r dext_table_border_b dext_table_border_l" colspan="4">주 소</td>
					<td colspan="4" class="detailColumn dext_table_border_t dext_table_border_r dext_table_border_b dext_table_border_l">
						<p style="text-align: center;"><span unselectable="on" contenteditable="false" class="comp_wrap" data-cid="5" data-dsl="{{text}}" data-wrapper="" style="width: 100%; font-family: &quot;malgun gothic&quot;, dotum, arial, tahoma; font-size: 9pt; line-height: 18px; margin-top: 0px; margin-bottom: 0px;" data-value="" data-autotype="">${empVO.empAdd1 }&nbsp; &nbsp; ${empVO.empAdd2 }</span></p>
					</td>
				</tr>
				<tr>
					<td class="subjectColumn dext_table_border_t dext_table_border_r dext_table_border_b dext_table_border_l" colspan="9">증명사항</td>	
				</tr>
				<tr>
					<td class="subjectColumn dext_table_border_t dext_table_border_r dext_table_border_b dext_table_border_l" colspan="4">재 직 기 간</td>
					<td class="detailColumn dext_table_border_t dext_table_border_r dext_table_border_b dext_table_border_l" style="" colspan="4">
						...
						<p style="text-align: center;"><span unselectable="on" contenteditable="false" class="comp_wrap" data-cid="7" data-dsl="{{period}}" data-wrapper="" style="" data-value="" data-autotype="">${hireDate } ~ ${docDate }</span></p>
					</td>
				</tr>	
				<tr>
					<td class="subjectColumn dext_table_border_t dext_table_border_r dext_table_border_b dext_table_border_l" colspan="4">소속 및 직위</td>
					<td class="detailColumn dext_table_border_t dext_table_border_r dext_table_border_b dext_table_border_l" style="" colspan="4">
						<p style="text-align: center;"><span unselectable="on" contenteditable="false" class="comp_wrap" data-cid="19" data-dsl="{{textarea}}" data-wrapper="" style="width: 100%;" data-value="" data-autotype="">${empVO.deptVO.deptName }/${empVO.codeVO.cdName }</span></p>
					</td>
				</tr>
				<tr>				
					<td class="subjectColumn dext_table_border_t dext_table_border_r dext_table_border_b dext_table_border_l" colspan="4">담당업무내용</td>
					<td class="detailColumn dext_table_border_t dext_table_border_r dext_table_border_b dext_table_border_l" colspan="4" >
						<p style="text-align: center;"><span unselectable="on" contenteditable="false" class="comp_wrap" data-cid="15" data-dsl="{{textarea}}" data-wrapper="" style="width: 100%;" data-value="" data-autotype="">${empVO.deptVO.deptName }</span></p>
					</td>
				</tr>
				<tr>
					<fmt:formatDate value="<%=date %>" pattern="yyyy년 MM월 dd일" var="now"/>
					<td style="text-align: center;" colspan="8" class="detailColumn dext_table_border_t dext_table_border_r dext_table_border_b dext_table_border_l">
						<br><br>
						<br><br><br><br><br>
						상기와 같이 재직하였음을 증명합니다.
						<br><br>
						<br><br><br><br><br>${now }<br><br><br>
...
function createPDF(){ // 이미지를 pdf로 만들기
	...
	$.when.apply($, deferreds).then(function () { // 이미지 렌더링이 	끝난 후
		...
		for (var i = 0; i < sortedLeng; i++) {
			...
			doc.save('경력증명서_IWORKS.pdf'); // pdf 저장
