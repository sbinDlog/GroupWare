...
<div class="echart-gauge-ring-chart-example" style="min-height: 300px; user-select: none; -webkit-tap-highlight-color: rgba(0, 0, 0, 0); position: relative;" _echarts_instance_="ec_1695798271683">
	<div style="position: relative; width: 723px; height: 300px; padding: 0px; margin: 0px; border-width: 0px; cursor: default;">
