            ...
            <div>
              ...
              <div class="mt-2">
                ...
                <div class="form-check form-check-inline">
                  <input class="form-check-input" id="inlineRadio2" type="radio" name="scSe" value="A101" checked="checked" />
...
<!-- 	          <div class="invalid-feedback">제목은 필수 입력 항목입니다.</div> -->
	        ...
	        <div class="modal-body px-card pb-card pt-1 fs--1">
	        	<div>
	        		<div class="form-check form-check-inline">
	                  <input class="form-check-input" id="inlineRadio2" type="radio" name="scSe" value="A101" disabled/><!-- 데이터 세팅되는 곳 : 유형 -->
	                  <label class="form-check-label" for="inlineRadio2">회사</label>
	                </div>
          ...
          <div class="w-100 d-flex justify-content-between align-items-start">
            <div>
              ...
              <div class="mt-2">
              	<!-- 관리자 부분 -->
                <div class="form-check form-check-inline">
                  <input class="form-check-input" type="radio" name="scSe" value="A101" checked="checked" />
                  <label class="form-check-label" for="inlineRadio2">회사</label>
                </div>
                <!-- 관리자 부분 -->
              </div>
